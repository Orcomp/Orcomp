namespace Orc.Algorithms.Sort.NSort.Generic
{
    /// <summary>
	...
	/// </para>
	/// </remarks>
	public class ShearSorter<T> // : SwapSorter<T>
	{
        //private int cols;
        //private int log;
        ...
        //public ShearSorter(IComparer<T> comparer, ISwap<T> swapper)
        ...
        //internal void SortPart1(IList<T> list, int Lo, int Hi, int Nx, bool Up)
        //{
        //    int c;
        ...
        //internal void SortPart2(IList<T> list, int Lo, int Hi, int Nx, bool Up)
        //{
        //    int c;
