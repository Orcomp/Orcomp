...
namespace Orcomp.Submissions
{
    public static class GetSortedDateTimes
    {
        public static Dictionary<string, Func<List<DateRange>, IEnumerable<DateTime>>> Contestants { get; set; }
        ...
        public static IEnumerable<DateTime> Run(this List<DateRange> orderedDateRanges, string contestant)
        {
        ...
        public static IEnumerable<DateTime> MoustafaS(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> Zaher(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> Aus1(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> Renze(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> V_Tom_R(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> SoftwareBender(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> ErwinReid(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> Mihai(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> Bawr(this List<DateRange> orderedDateRanges)
        {
        ...
        public static IEnumerable<DateTime> C6c(this List<DateRange> orderedDateRanges)
        {
