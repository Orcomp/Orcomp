...
/*
    public class EnumeratorProxyWithPrevious<T> : IEnumerator<T>
    {
        protected IEnumerator<T> BaseEnumerator { get; set; }
        protected bool HasMoved { get; set; }

        public EnumeratorProxyWithPrevious(IEnumerator<T> enumerator)
        {
            BaseEnumerator = enumerator;
        }

        public EnumeratorProxyWithPrevious(IEnumerable<T> enumerable)
        {
