namespace Orc.Tests.DateIntervalExtensionsAccountForEfficiencies
{
    ...
    public class AccountForEfficienciesNoOverlapTest
    {
        ...
        public void AccountForEfficienciesCustom_NoOverlap_WithZeroAtEnd()
        {
            ...
            var efficiency1 = new DateIntervalEfficiency(new DateInterval(this.start, this.start.AddMinutes(30)), 50); // 30 mins at 50%
            var efficiency2 = new DateIntervalEfficiency(new DateInterval(this.start.AddMinutes(65), this.start.AddMinutes(75)), 0); // 10 mins at 0%
            var efficiency3 = new DateIntervalEfficiency(new DateInterval(this.start.AddMinutes(90), this.start.AddMinutes(100)), 0); // 10 mins at 0%
            this.dateIntervalEfficiencies.Add(efficiency1);
            this.dateIntervalEfficiencies.Add(efficiency2);
            this.dateIntervalEfficiencies.Add(efficiency3);
            ...
            // Assert
            var result = new DateInterval(this.start, this.start.AddMinutes(85));
            Assert.AreEqual(result, newDateInterval);
        }
        ...
        public void AccountForEfficienciesCustom_NoOverlap_WithZeroAtStart()
        {
            ...
            var dateInterval = new DateInterval(this.start.AddMinutes(40), this.start.AddMinutes(100));

            var efficiency1 = new DateIntervalEfficiency(new DateInterval(this.start.AddMinutes(40), this.start.AddMinutes(70)), 50); // 30 mins at 50%
            var efficiency2 = new DateIntervalEfficiency(new DateInterval(this.start.AddMinutes(25), this.start.AddMinutes(35)), 0); // 10 mins at 0%
            var efficiency3 = new DateIntervalEfficiency(new DateInterval(this.start, this.start.AddMinutes(10)), 0); // 10 mins at 0%
            this.dateIntervalEfficiencies.Add(efficiency1);
            this.dateIntervalEfficiencies.Add(efficiency2);
            this.dateIntervalEfficiencies.Add(efficiency3);
            ...
            // Assert
            var result = new DateInterval(this.start.AddMinutes(15), this.start.AddMinutes(100));//RANGE 85 MINUTES
            Assert.AreEqual(result, newDateInterval);
        }
